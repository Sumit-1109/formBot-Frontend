  ...
  return (
    <div className={`${styles.navBar} ${theme ? styles.dark : styles.light}`} >
        ...
        <div className={styles.dashBoardNameAndSettings}>
            ...
            <div className={`${styles.dropDownHeader} ${theme ? styles.dark : styles.light} ${isOpen ? styles.open : ''}`}>
                ...
                {
                    isOpen && (
                        <div className={`${styles.dropDownList} ${theme ? styles.dark : styles.light} `}>
                            <ul className={styles.list}>
                                <li onClick={() => navigate(`/settings`)} className={`${styles.listItems} ${theme ? styles.dark : styles.light}`}>Settings</li>
